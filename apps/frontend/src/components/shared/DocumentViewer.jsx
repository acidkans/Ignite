...
import { Maximize2, Minimize2, Download, X, ZoomIn, ZoomOut, CheckCircle, RotateCcw, FileText, ChevronRight, Link2, AlertCircle, ChevronDown, Sparkles, Trash2, Highlighter } from 'lucide-react';
...
function PdfPageWithHighlights({ pageNumber, width, pageHighlights, activeHighlightId, onSetActive, onCreate, onDelete, onUpdateColor }) {
    ...
    if (pageHighlights.length > 0) {
        ...
        console.log(`[PdfPage ${pageNumber}] rendering ${pageHighlights.length} highlight(s)`, pageHighlights);
    }
    ...
    return (
        ...
        >
            ...
            {/* Highlight overlay — z jawnymi inline-style, żeby ominąć ew. konflikty Tailwind/CSS */}
